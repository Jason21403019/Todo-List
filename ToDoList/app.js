...
add.addEventListener("click", (e) => {
  // prevent form from begin subimtted
  e.preventDefault();
  ...
  // create green ckeck and red trash can
  let compeleteButton = document.createElement("button");
  compeleteButton.classList.add("complete");
  compeleteButton.innerHTML = '<i class="fa-solid fa-square-check"></i>'; //這裡只能用‘’表示。
  ...
  form.children[0].value = ""; //clear the text inpute
...
function loadData() {
  ...
  if (myList != null) {
    ...
    myListArray.forEach((item) => {
      ...
      let compeleteButton = document.createElement("button");
      compeleteButton.classList.add("complete");
      compeleteButton.innerHTML = '<i class="fa-solid fa-square-check"></i>';
